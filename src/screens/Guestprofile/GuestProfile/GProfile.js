...
const GProfile = ({navigation}) => {
  return (
    ...
    <View>
        ...
        <Text style={styles.txtConst}>Let's describe you as GUEST</Text>
    </View>
    <View>
        <Image source={require('../assets/Guest.png')} style={styles.imageConst} />
    </View>
...
<TouchableOpacity onPress={() => navigation.navigate('GuestWishlist')}>
