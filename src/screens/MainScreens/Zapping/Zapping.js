...
//FOR SLIDING
const images = [
  'file:///Users/extechdigital/Desktop/CloneRepo/eatmates_testing/src/assets/amelia.png',
...
const Zapping = ({ navigation }) => {
  ...
  const [dolabeltime, setDolabelTime] = useState('Select time')
          ...
          <View style={styles.centerContPartTwo}>
            ...
            <View style={styles.dropdown}>
              <View>
               ...
               <View style={styles.dropdownright}>
                <Text style={styles.textonly}>Time Prefrence</Text>

                <View style={{ borderWidth: 1, borderColor: '#969696', width: 135, height: 42, }}>
                  <Pressable onPress={() => setOpen(true)} >
                    <View>
                      <Text style={styles.datetext} placeholder="Date">{dolabeltime}</Text>
                    </View>
                  </Pressable>
                  {/* <DatePicker
                    modal
            ...
            <View style={styles.recentlybook}>
              ...
              <Pressable style={styles.nextbtn} onPress={() => { navigation.navigate('AddOtpScreen') }}>
                <Text style={styles.nextbtntext}>Invite</Text>
              </Pressable>
            </View>
